...
<body>
                ...
                <div class="search-input">
                    <form action="<?php echo BASEPATH ?>/products/search" method="POST" id="search">
                        <input type="text" id="keyword" name="keyword" value="<?php if (isset($keyword)) {
                                                                                    echo $keyword;
                                                                                } ?>" placeholder="Enter keyword here" onchange="showdata(this.value)">
                    </form>
                </div>
    ...
    <script>
        ...
        var keyword = ["IPhone", "SamSung", "Vivo", "Vsmart", "Nokia", "IPhone 12", "IPhone 11", "Oppo", "Xiaomi","SamSung 9","Vivo X50"];
        autocomplete(document.getElementById("keyword"), keyword);
    </script>