        ...
        <div class="container-form">
            <div class="signup">
                ...
                <form action="<?php echo BASEPATH ?>/admins/editUser/<?php echo $eUser['id'] ?>" class="signup-form" autocomplete="off" method="POST">
                    ...
                    <input type="password" id="password" name="password" class="signup-input" value="<?php echo $eUser['password'] ?>">
                    <label for="name" class="signup-label">Name</label>
                    <input type="text" id="name" name="name" class="signup-input" value="<?php echo $eUser['name'] ?>">
                    <label for="date" class="signup-label">Date</label>
                    <input type="date" id="date" name="date" class="signup-input" value="<?php echo $eUser['date'] ?>">
                    <label for="phone" class="signup-label">Phone</label>
                    <input type="text" id="phone" name="phone" class="signup-input" value="<?php echo $eUser['phone'] ?>">
                    <label for="address" class="signup-label">Address</label>
                    <input type="text" id="address" name="address" class="signup-input" value="<?php echo $eUser['address'] ?>">
                    <?php 
                    if(isset($dangerous)){
